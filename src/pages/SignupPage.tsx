...
const signupSchema = z.object({
  ...
  role: z.enum(["student", "educator"] as const),
});
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 10, textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.75)", maxWidth: 360 }}>
            Start your learning journey today. Build streaks, master skills, and achieve your goals.
          </p>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 32, background: "#fff" }}>
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} style={{ width: "100%", maxWidth: 440 }}>
          ...
          <p style={{ marginTop: 8, color: "#94a3b8", fontSize: 14 }}>
            ...
            <Link to="/login" style={{ fontWeight: 600, color: "#6366f1" }}>Log in</Link>
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{ marginTop: 32, display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                {([
                  { role: "student" as const, Icon: User, label: "Student", color: "#6366f1" },
                  { role: "educator" as const, Icon: GraduationCap, label: "Educator", color: "#8b5cf6" },
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "14px 16px",
                      borderRadius: 14,
                      border: `2px solid ${selectedRole === role ? color : "#e2e8f0"}`,
                      background: selectedRole === role ? color + "0a" : "transparent",
            ...
            <div>
              ...
              {errors.name && <p style={{ marginTop: 6, fontSize: 13, color: "#ef4444", fontWeight: 500 }}>{errors.name.message}</p>}
            </div>
